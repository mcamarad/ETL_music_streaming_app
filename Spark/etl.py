...
def create_spark_session():
    ...
    Creates SparkSession object and returns it. If SparkSession is already created it returns
...
def process_song_data(spark, input_data, output_data):
    ...
    Processing song data from S3 to local directory. 
...
def main():
    ...
    output_data = config['OUTPUT_PATH']
